...
4. Start the server:
   ...
   uv run uvicorn reversing_mcp.server:app --port 10750
   ```
5. Open `http://localhost:10750` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/reversing-mcp/issues) |
