      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="border-slate-800 bg-slate-950/50">
          ...
          <CardContent className="text-sm text-slate-400 space-y-4">
            <p>
              This MCP server provides a standardized interface for Reverse
              Engineering operations. It facilitates binary analysis, system
              probing, and instrumentation.
            </p>
            <p>
              Backend: API runs on port 10750. Start it (e.g.{" "}
              ...
              backend). Configure in Settings.
            </p>
            <p>Key concepts:</p>
            <ul className="list-disc list-inside space-y-1">
              <li>
                Analyze: upload a binary, run file/strings/entropy, PE, or
                Ghidra
              </li>
              <li>
                Ghidra: install Ghidra + ReVa; add ReVa MCP in your IDE for
                decompilation
              </li>
